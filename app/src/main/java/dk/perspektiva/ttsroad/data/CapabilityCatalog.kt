...
object CapabilityCatalog {
    ...
    private val labels: Map<String, String> = mapOf(
        ...
        "playback_skips" to "Skip adverts",
        ...
        "bulk_unfollow" to "Empty your shelf in one go",
        "notifications" to "New-chapter notices",
        "backlog_notifications" to "Per-fiction chapter notices",
        ...
        "listening_stats" to "Listening statistics",
        "account_security" to "Password and two-factor",
        "audiobook_export" to "Audiobook exports",
        "ebook_export" to "Download EPUBs",
        "logs" to "Server logs",
        "storage" to "Server disk usage",
        "voice_catalogue" to "Voice list",
